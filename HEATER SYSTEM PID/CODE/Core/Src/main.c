...
int main(void) {
	...
	CLCD_I2C_WriteString(&LCD1, "helloanhem1111");
...
static void MX_GPIO_Init(void) {
	...
	/*Configure GPIO pins : SW_Pin BT1_Pin BT2_Pin BT3_Pin */
	GPIO_InitStruct.Pin = SW_Pin | BT1_Pin | BT2_Pin | BT3_Pin;
